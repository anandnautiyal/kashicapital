...
alter table kashicapital.LOAN_APPLICATION_CUSTOMER 
add DOMESTIC_CAPACITY numeric(10),
add TOTAL_DOMESTIC_LIABILITY numeric(10),
add TOTAL_COMMERCIAL_LIABILITY numeric(10),
add TOTAL_CAPACITY numeric(10),
add TOTAL_LIABILITY numeric(10),
add LOAN_PURPOSE nvarchar(50);

alter table kashicapital.LOAN_CUSTOMER_LOAN_DETAIL 
add LEGAL_STATUS nvarchar(20);
...
INSERT INTO kashicapital.loan_type(LOAN_TYPE_ID,LOAN_TYPE_CODE,LOAN_TYPE_NAME)VALUES(1,'सावधि ऋण','सावधि ऋण');


INSERT INTO kashicapital.loan_type(LOAN_TYPE_ID,LOAN_TYPE_CODE,LOAN_TYPE_NAME)VALUES(2,'अन्य ऋण','अन्य ऋण');
...
INSERT INTO kashicapital.loan_customer_asset(ID,LOAN_CUSTOMER_ID,ASSET_TYPE,CUSTOMER_ASSET_TYPE_ID,ASSET_QUANTITY,ASSET_COST,ASSET_DESCRIPTION,TOTAL_BUSINESS_ASSET,TOTAL_HOME_ASSET,DATE_CREATED,DATE_MODIFIED,asset)VALUES(1,1110,'अचल',2,2,5000,'होम लैंड ',0,2,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'मशीन ');
