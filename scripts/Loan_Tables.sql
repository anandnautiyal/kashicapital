...
"AADHAR_NUMBER" VARCHAR2(20 CHAR),
...
INSERT INTO APPLICATION_LOAN_DETAIL (ID, LOAN_ID, LOAN_TYPE_ID, LOAN_AMOUNT, LOAN_TERM, LOAN_OBJECTIVE, DEVICE_TYPE, DEVICE_LOAN_OBJECTIVE, SUPPLIER_NAME, COST_OF_MACHINE, CUSTOMER_CONTRIBUTION_AMOUNT, LOAN_AMOUNT_REQUIRED)
VALUES (1, 1110, (select LOAN_TYPE_ID from LOAN_TYPE where LOAN_TYPE_CODE ='L1'), 100000, 5, 'Buy Machinery', 'Tractor', 'Buy', 'Mahindra', 500000, 100000, 400000);
