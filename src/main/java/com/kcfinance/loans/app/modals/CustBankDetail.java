...
/**
 * The persistent class for the cust_bank_detail database table.
 * 
 */
@Entity
@Table(name="cust_bank_detail")
@NamedQuery(name="CustBankDetail.findAll", query="SELECT c FROM CustBankDetail c")
public class CustBankDetail implements Serializable {
