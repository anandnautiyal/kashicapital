...
/**
 * The persistent class for the cust_loan_detail database table.
 * 
 */
@Entity
@Table(name="cust_loan_detail")
@NamedQuery(name="CustLoanDetail.findAll", query="SELECT c FROM CustLoanDetail c")
public class CustLoanDetail implements Serializable {
